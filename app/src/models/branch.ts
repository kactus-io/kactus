...
export class Branch {
   ...
   * one of Kactus's automatically created (and pruned) fork remotes. I.e. a
   * remote branch from a branch which starts with `kactus-`.
   *
   * We hide branches from our known Kactus for remotes as these are considered
   ...
   * names
   **/
  public get isKactusForkRemoteBranch() {
    return (
