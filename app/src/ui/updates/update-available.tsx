  ...
  public render() {
    return (
      ...
      >
        ...
        <span>
          An updated version of Kactus is available and will be installed at the next launch. See <LinkButton uri={this.props.releaseNotesLink}>what's new</LinkButton> or <LinkButton onClick={this.updateNow}>restart now</LinkButton>.
        </span>
