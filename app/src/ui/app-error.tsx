  ...
  private renderErrorMessage(error: Error, unhandled: boolean) {
    if (unhandled) {
      ...
      return (
        <div>
          <p>
            Kactus encountered an uncaught exception, leaving it in an invalid
            state.
          </p>
          <p>
            This has been reported to the team, but if you encounter this
            repeatedly please report this issue to the Kactus{' '}
            <LinkButton uri="https://github.com/kactus-io/kactus/issues">
              issue tracker
            </LinkButton>.
          </p>
          {errorDetails}
