...
export class App extends React.Component<IAppProps, IAppState> {
  ...
  public constructor(props: IAppProps) {
    ...
    ipcRenderer.on(
      'launch-timing-stats',
      (event: Electron.IpcRendererEvent, { stats }: { stats: any }) => {
  ...
  public componentDidMount() {
    ...
    document.body.ondrop = e => {
      if (this.isShowingModal || !e.dataTransfer) {
        return
      }
      if (e.dataTransfer != null) {
  ...
  private async handleDragAndDrop(fileList: FileList) {
    ...
    // it if needed.
    if (paths.length > 1) {
      const addedRepositories = await dispatcher.addRepositories(paths, false)
  ...
  private renderTitlebar() {
    ...
    const titleBarStyle =
      inWelcomeFlow || inNoRepositoriesView ? 'light' : 'dark'
    ...
    if (selectedState.type === SelectionType.Repository) {
      ...
      return (
        <RepositoryView
          ...
          externalEditorLabel={externalEditorLabel}
          sketchVersion={state.sketchVersion}
