...
/** Text to let the user know their browser will send them back to Kactus */
export const BrowserRedirectMessage =
  "Your browser will redirect you back to Kactus once you've signed in. If your browser asks for your permission to launch Kactus please allow it to."
...
interface IAuthenticationFormProps {
   ...
   *
   * ("Basic auth" is logging in via user + password entered directly in Kactus.)
   */
