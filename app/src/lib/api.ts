...
const DotComOAuthScopes = ['repo', 'read:user', 'user:email', 'workflow']
...
export function getDotComAPIEndpoint(): string {
  // NOTE:
  // `GITHUB_DOTCOM_API_ENDPOINT` only needs to be set if you are
  ...
  // unset.
  const envEndpoint = process.env['GITHUB_DOTCOM_API_ENDPOINT']
