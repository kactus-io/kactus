...
function getDescriptionForError(error: DugiteError): string {
  switch (error) {
    ...
    case DugiteError.CannotMergeUnrelatedHistories: return 'Cannot merge unrelated histories.'
    case DugiteError.PushWithPrivateEmail: return 'Push with private email.'
