...
As Kactus uses Webpack to transpile, minify and merge our code
...
For example, you might come across this code in [`app-window.ts`](https://github.com/kactus-io/kactus/blob/master/app/src/main-process/app-window.ts):
...
The replacements defined for Kactus are found in [`app/app-info.js`](https://github.com/kactus-io/kactus/blob/master/app/app-info.js)
as a hash of key-value pairs.

```ts
function getReplacements() {
  return {
    __OAUTH_CLIENT_ID__: s(process.env.KACTUS_OAUTH_CLIENT_ID || devClientId),
    __OAUTH_SECRET__: s(
...
globals under [`app/src/lib/globals.ts`](https://github.com/kactus-io/kactus/blob/master/app/src/lib/globals.d.ts)
